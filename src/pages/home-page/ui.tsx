  ...
  return (
    <Container className={st.home}>
      ...
      <p>
        ...
        страницу авторизации. Попробуйте)
      </p>
      ...
      <p>
        ...
        где-то мог что-то упустить, возможно какие-то компоненты нужно немного переработать (в
        частности, было бы уместнее карточки редактирования сделать формами, добавить доступности) и
        т.д. Но поскольку с таким подходом можно провозиться и месяц, то имеем что имеем!
      </p>
    </Container>
  );
};
